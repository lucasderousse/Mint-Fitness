...
export default function Hero() {
    return (
        <div className='min-h-screen flex flex-col gap-10 items-center justify-center text-center max-w-[800px] w-full mx-auto p-4'>
            ...
            <p className='text-xs'>Check out the <a href="https://lucasderousse.github.io/" className='font-bold text-green-400 underline'>creator</a>, or the <a href="https://github.com/lucasderousse/Mint-Fitness" className='font-bold text-green-400 underline'>github</a> for this project</p>
        </div>
    )
}
